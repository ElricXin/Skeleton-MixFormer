...
[![PWC](https://img.shields.io/endpoint.svg?url=https://paperswithcode.com/paper/skeleton-mixformer-multivariate-topology)](https://paperswithcode.com/sota/skeleton-based-action-recognition-on-ntu-rgbd?p=skeleton-mixformer-multivariate-topology)
